...
<script type="text/javascript">
    document.addEventListener("DOMContentLoaded", function(event) {
        let url = './api/proccess.php?action=vistor&page=wo874j_page&type=page_view'
        fetch(url)
            .then(response => {
                // handle the response
            })
    ...
    document.addEventListener("click", function(event) {
        let url = './api/proccess.php?action=vistor&page=wo874j_page&type=page_click'
        fetch(url)
            .then(response => {
                // handle the response
            })
