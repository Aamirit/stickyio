...
define('geo','esen');
define('geo2','en-ES');
define('klarna2','en-ES');
define('racine','eu');
define('racinelanding','usd');
...
define('hour','Hours');
define('sec','Seconds');
define('remplaceprice1','Instead of: $226.95');
define('remplaceprice2','Instead of: $151.30');
...
define('prixpacko','$45.08');
define('prixklarna2','');
define('prixtotalo','$135.23');
...
define('prixpacki','$51.38');
define('prixklarna3','');
define('prixtotali','$102.77');
...
define("REGIST_NO",'Ettevõtte registreerimisnumber');
define("VAT_NO","Käibemaksukohustuslase number");
define("registered_address","Registreeritud aadress");
define('upsell_1','Limpia tu cuerpo');
