...
define('geo','au');
define('geo2','en-AU');
define('klarna2','en-AU');
define('racine','eu');
define('racinelanding','aud');
...
define('forcepays','Australia');
define('forcepays2','AU');
...
define('hour','Hours');
define('sec','Seconds');
define('remplaceprice1','Instead of: $341.01 AUD');
define('remplaceprice2','Instead of: $227.35 AUD');
...
define('prixpacko','$67.73 AUD');
define('prixklarna2','');
define('prixtotalo','$203.19 AUD');
...
define('prixpacki','$77.21 AUD');
define('prixklarna3','');
define('prixtotali','$154.43 AUD');
