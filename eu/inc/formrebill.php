<form class="bg-blue-500 rounded-xl flex flex-col sm:flex-row p-4 sm:p-8 space-y-8 sm:space-y-0 sm:space-x-8"  action="https://submit.jotform.com/submit/<?php echo formid;?>/" method="post" name="form_<?php echo formid;?>" id="<?php echo formid;?>" accept-charset="utf-8" autocomplete="on">
        ...
        <div id="cid_3" class="form-input-wide jf-required" data-layout="full">
          ...
          <div data-wrapper-react="true" id="mollie-payment-wrapper" class="mollie-payment-wrapper" data-sandbox="No" data-mollie-currency="EUR">
            ...
            <div data-wrapper-react="true" class="product-container-wrapper">
              ...
              <div data-wrapper-react="true">
                <span class="form-product-item hover-product-item  full_img new_ui" categories="non-categorized" pid="1000" aria-labelledby="label_3">
                  <div data-wrapper-react="true" class="form-product-item-detail new_ui">
                    <div class="p_col">
                      <div class="p_checkbox">
                        <input type="radio" class="form-radio validate[required]  form-product-input" id="input_3_1000" name="q3_mesProduits[][id]" value="1000" />
                        <div class="checked">
                        </div>
                    ...
                    <div for="input_3_1000" class="form-product-container">
                      <span data-wrapper-react="true">
                        <div class="title_description">
                          <span class="form-product-name" id="product-name-input_3_1000">
                            <?php echo quantpack1;?>
                          </span>
                          <span class="form-product-description" id="product-name-description-input_3_1000">
                          </span>
                        </div>
                ...
                <span class="form-product-item hover-product-item  full_img new_ui" categories="non-categorized" pid="1002" aria-labelledby="label_3">
                  <div data-wrapper-react="true" class="form-product-item-detail new_ui">
                    <div class="p_col">
                      <div class="p_checkbox">
                        <input type="radio" class="form-radio validate[required]  form-product-input" id="input_3_1002" name="q3_mesProduits[][id]" value="1002" checked=""/>
                        <div class="checked">
                        </div>
                        <div class="select_border">
                        </div>
