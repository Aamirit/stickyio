    ...
    this.form.addEventListener("submit", function(event) {
      ...
      if (JotForm.isPaymentSelected()) {
        if (paymentSelected === false) {
          JotForm.errored($('mollie_dummy'), 'Le mode de paiement n&#039;est pas sélectionné.');
          // this.pleaseWaitButton();
          // this.form.submit();
          this.resetButton();
        } else {
            ...
            if (Object.isArray(apmList)) {
              ...
              if (self.isApplePay) {
                ...
                if (listHasCreditCard.length === 0) {
                  var objCreditCard = {
                    id: 'creditcard',
                    image: 'https://novaketo.com/eu/img/mollie-creditCard.svg'
                  };
  ...
  prettifyApmName: function(gateway) {
    ...
    switch (gateway.id) {
      ...
      case 'klarnapaylater':
        ...
        break;
      case 'klarnasliceit':
        apmName = 'Payer en 3 fois sans frais avec Klarna';
        break;
      case 'creditcard':
        apmName = 'Visa, MasterCard ou American Express';
        break;
        case 'belfius':
          apmName = 'Belfius - App bancaire belge';
          break;
      case 'kbc':
        apmName = 'KBC/CBC Paiement Button';
        break;
      case 'giftcard':
        apmName = 'Gift Cards';
        break;
