...
Langue
*/
define('Australie','<option value="Australie"> Australie </option>');
define('Canada','<option value="Canada"> Canada </option>');
define('États-Unis','<option value="États-Unis"> États-Unis </option>');
define('Irlande','<option value="Irlande"> Irlande </option>');
define('Nouvelle-Zélande','<option value="Nouvelle-Zélande"> Nouvelle-Zélande </option>');
define('Royaume-Uni','<option value="Royaume-Uni"> Royaume-Uni </option>');
define('Afrique du Sud','<option value="Afrique du Sud"> Afrique du Sud </option>');
define('Inde','<option value="Inde"> Inde </option>');
define('Pakistan','<option value="Pakistan"> Pakistan </option>');
define('Philippines','<option value="Philippines"> Philippines </option>');
define('Singapour','<option value="Singapour"> Singapour </option>');
define('Nigeria','<option value="Nigeria"> Nigeria </option>');
define('Ghana','<option value="Ghana"> Ghana </option>');
define('Kenya','<option value="Kenya"> Kenya </option>');
define('Tanzanie','<option value="Tanzanie"> Tanzanie </option>');
define('Ouganda','<option value="Ouganda"> Ouganda </option>');
define('Zambie','<option value="Zambie"> Zambie </option>');
define('Zimbabwe','<option value="Zimbabwe"> Zimbabwe </option>');
define('Malawi','<option value="Malawi"> Malawi </option>');
define('Botswana','<option value="Botswana"> Botswana </option>');
define('Namibie','<option value="Namibie"> Namibie </option>');
define('Lesotho','<option value="Lesotho"> Lesotho </option>');
define('Eswatini','<option value="Eswatini"> Eswatini </option>');
define('Trinité-et-Tobago','<option value="Trinité-et-Tobago"> Trinité-et-Tobago </option>');
define('Jamaïque','<option value="Jamaïque"> Jamaïque </option>');
define('Barbade','<option value="Barbade"> Barbade </option>');
define('Bahamas','<option value="Bahamas"> Bahamas </option>');
define('Belize','<option value="Belize"> Belize </option>');
define('Guyana','<option value="Guyana"> Guyana </option>');
define('Sainte-Lucie','<option value="Sainte-Lucie"> Sainte-Lucie </option>');
define('Grenade','<option value="Grenade"> Grenade </option>');
define('Saint-Kitts-et-Nevis','<option value="Saint-Kitts-et-Nevis"> Saint-Kitts-et-Nevis </option>');
define('Dominique','<option value="Dominique"> Dominique </option>');
define('Saint-Vincent-et-les-Grenadines','<option value="Saint-Vincent-et-les-Grenadines"> Saint-Vincent-et-les-Grenadines </option>');
define('Antigua-et-Barbuda','<option value="Antigua-et-Barbuda"> Antigua-et-Barbuda </option>');
...
define('footertitreurl1','What is Klarna?');
...
define('hour','Hours');
define('sec','Seconds');
define('remplaceprice1','Instead of: €209.70');
define('remplaceprice2','Instead of: €139.80');
