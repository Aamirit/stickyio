...
<body class="d-flex flex-column orderpage">
               ...
               <div class="neos-contentcollection">
                  <div class="image">
                     <div class="text-center">
                         <img class="img-fluid m-5" src="./img/<?php echo $img; ?>"/>

                         <form  method="post" id="u1frm" >
                           <input type="hidden" name="u1_id" value="5">
                        ...
                        <form id="nothanks">
                        <input type="hidden" name="u1_id_skip" value="5">
                           <button type="submit" class="btn desktop-dis">No, Thankyou</button>
                        </form>
                     </div>
                  </div>
               </div>
   ...
   <script src="https://code.jquery.com/jquery-3.6.4.js" integrity="sha256-a9jBBRygX1Bh5lt8GZjXDzyOB+bWve9EiO7tROUtj/E=" crossorigin="anonymous"></script>
       <script src="https://www.paypal.com/sdk/js?client-id=ARpwn_WrDUK6pQpvzQIMLpCaj85fktud-DT7foGFjoZ-p0iX0SL-RaBqT8eLib8B_wVNQKoRPG5RMLtT&enable-funding=<?php echo $fundingsource; ?>&currency=<?php echo $all_products[$lang][5]['currency']; ?>&components=buttons,funding-eligibility&disable-funding=credit,card"></script>
       <script src="https://cdn.jsdelivr.net/npm/gasparesganga-jquery-loading-overlay@2.1.7/dist/loadingoverlay.min.js"></script>
       <script type="text/javascript">
           document.addEventListener("DOMContentLoaded", function(event) {
               let url = './api/proccess.php?action=vistor&page=u1_page&type=page_view'
               fetch(url)
                   .then(response => {
                       // handle the response
                   })
           ...
           document.addEventListener("click", function(event) {
               let url = './api/proccess.php?action=vistor&page=u1_page&type=page_click'
               fetch(url)
                   .then(response => {
                       // handle the response
                   })
       ...
       <script>
               ...
               paypal.Buttons({
                   ...
                   onApprove: function(data, actions) {
                       return actions.order.capture().then(function(details) {
                           ...
                           window.location = "./u2.php?lang=fr";
                       });
                   },
           ...
           $(document).ready(function(){
               let price_unit = <?php echo $all_products[$lang][5]['price']; ?>;
               let currency = <?php echo $all_products[$lang][5]['currency']; ?>;
      ...
      $(document).ready(function(){
      $(document).on('submit', '#u1frm', function (e) {
      e.preventDefault();
          layerStart();
      var obj = $(this);
      ...
      $(document).on('submit', '#nothanks', function (e){
         e.preventDefault();
         var obj = $(this);
       var formData = $(this).serializeArray();
      $.ajax({
          url: "api/proccess.php?action=nothanksu1",
          data: formData,
          dataType: 'JSON',
          method: 'POST'
      }).then(function(){
